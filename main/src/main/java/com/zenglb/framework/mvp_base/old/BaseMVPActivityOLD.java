 ...
 * 这里是通过{@link BaseMVPActivityOLD}s {@link BaseMVPActivityOLD#initCommonData} method来在P 中关联M和V
 *
 * P和M 通过下面的代码实例化
...
@Deprecated
public abstract class BaseMVPActivityOLD<P extends MyBasePresenter, M extends BaseModel> extends BaseActivity implements IView {
